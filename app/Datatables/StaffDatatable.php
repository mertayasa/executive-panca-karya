    ...
    static public function set($staff)
    {
        return Datatables::of($staff)
            ...
            ->addColumn('action', function ($staff) {
                return
                '<div class="btn-group">' .
                    '<a href="' . route('staff.edit', $staff->id) . '" class="btn btn-warning" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Edit" style="margin-right: 5px" ><i class="menu-icon fa fa-pencil-alt"></i></a>' .
