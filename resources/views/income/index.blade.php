      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header d-flex justify-content-between">
            ...
            <div class="right">
              {{-- <button class="btn btn-warning btn-icon icon-left mr-3"><i class="fas fa-print"></i> Print Pendapatan</button> --}}
              <a href="{{route('income.print_form')}}" class="btn btn-warning"> <i class="fas fa-print"></i> Print Pendapatan</a>
